...
# Note from Niels:
# code is taken from https://github.com/adamtornhill/maat-scripts/blob/python3/merge/merge_comp_freqs.py
# and slightly modified. As long as this file is present, all code falls under GNU GPL
...
def write_csv(stats):
    print('entity,revisions,lines-of-code')
    for s in stats:
        name, (f, c) = s
        print(name + ',' + f + ',' + c)
